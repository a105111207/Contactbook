...
<body class="body">
    ...
    <form method="post" action="./MySQLaction.php">
        ...
        <h3 id="h3">*學生-生活札記: </h3>
        札記內容:　<textarea class="textareatext" name="diary" row="30" cols="60"><?php sessioncod("diary"); ?></textarea><br />
        <hr />
		
		上課筆記:　
		<textarea class="textareatext" name="note" row="30" cols="60"><?php sessioncod("note"); ?></textarea><br />
        <hr />
		

		<h3 id="h3">*家長-簽核聯絡簿: </h3>
        <input class="" type="checkbox" name="pc" value="1" disabled="true" <?php bothcheck("parcheck"); ?>>家長確認　<br />
        家長評語:　<textarea class="textareatext" name="parcheck" row="30" cols="60" readonly><?php sessioncod("parcomment"); ?></textarea><br />
        <hr />
